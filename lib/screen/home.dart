...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final flightNumberRegExp1 = RegExp(r'(EM|em|eM|Em){2}[0-9]{1}');
  final flightNumberRegExp2 = RegExp(r'(EM|em|eM|Em){2}[0-9]{2}');
  final flightNumberRegExp3 = RegExp(r'(EM|em|eM|Em){2}[0-9]{3}');
  final flightNumberRegExp4 = RegExp(r'(EM|em|eM|Em){2}[0-9]{4}');
  ...
  void _callFlightAPI (String flightNumber) async {
    ...
    print('callFlightAPI called');
    const key = 'c1a9697f9b6263fffcb12a94543e68fa';
    const url = 'https://api.aviationstack.com/v1/flights?access_key=$key';
    print('callFlightAPI url set');
    final uri = Uri.parse(url);
    print('callFlightAPI uri parsed');
    final response = await http.get(uri);
    print('callFlightAPI fetched response');
  ...
  void _validateFlightInput (String flightNumber) {
    ...
    String errorMessageFormat = 'The flight number you entered is invalid! Please see the example formats.';
